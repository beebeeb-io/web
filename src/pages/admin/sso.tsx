  ...
  return (
    <AdminShell activeSection="sso">
      <div className="flex items-center gap-2.5 px-5 py-3.5 border-b border-line">
        ...
        <span className="text-sm font-semibold text-ink">Single Sign-On</span>
      ...
      <div className="px-5 py-16 text-center">
        <div className="w-14 h-14 mx-auto mb-4 rounded-xl bg-paper-2 border border-line-2 border-dashed flex items-center justify-center">
          <Icon name="shield" size={24} className="text-ink-4" />
        </div>
        <h3 className="text-sm font-semibold text-ink mb-1">SAML / OIDC integration</h3>
        <p className="text-[13px] text-ink-3 max-w-sm mx-auto">
          Connect Okta, Entra ID, JumpCloud, or any SAML 2.0 / OIDC provider.
          Enforce SSO for your organization with just-in-time provisioning and SCIM sync.
        </p>
