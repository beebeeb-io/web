...
function VaultSwitcher() {
  ...
  // One personal vault today. Business/team vaults are deferred post-launch
  // (spec 032 decision, task 0258), so this is a non-interactive vault identity
  // pill — NOT a switcher. A dropdown that opens to reveal only your own vault
  // is a placeholder affordance, and a disabled "Coming soon" row violates the
  // brand bar. The switcher returns when shared vaults actually ship.
  return (
    <div className="px-3 pb-2">
      <div className="w-full flex items-center gap-2 px-2.5 py-1.5 rounded-full border border-line bg-paper-2 text-[13px] font-medium text-ink-2">
        <svg
          width="13"
          height="13"
          viewBox="0 0 24 24"
