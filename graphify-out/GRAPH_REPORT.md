# Graph Report - web  (2026-05-31)

## Corpus Check
- 299 files · ~317,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1688 nodes · 2341 edges · 49 communities detected
- Extraction: 79% EXTRACTED · 21% INFERRED · 0% AMBIGUOUS · INFERRED: 492 edges (avg confidence: 0.8)
...
Cohesion: 0.02
Nodes (141): fireConnectionStatus(), fireErrorNotifier(), fireSessionExpired(), delay(), paceIfNeeded(), reportConnection(), request(), updateRateLimitState() (+133 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (107): decryptAll(), handleNewFolder(), handleSubmit(), copyToClipboard(), handleCopy(), handleRevoke(), handleDelete(), handleDownload() (+99 more)

### Community 2 - "Community 2"
Cohesion: 0.04
Nodes (64): loadNames(), computeRecoveryCheck(), decryptChunk(), decryptFileMetadata(), decryptFilename(), decryptManyNames(), deriveFileKey(), deriveKeys() (+56 more)
...
Cohesion: 0.07
Nodes (29): getApiUrl(), downloadSharedFile(), downloadVersion(), getFileRequestPublic(), listFiles(), uploadToFileRequest(), canStreamToServiceWorker(), createBlobSink() (+21 more)
...
Cohesion: 0.07
Nodes (15): savePermissions(), setExpiry(), confirmAction(), getSharesForFile(), patchInvite(), permanentDeleteFile(), restoreFile(), loadActivity() (+7 more)
...
- **Thin community `Community 74`** (5 nodes): `formatSize()`, `getExtension()`, `getMimeLabel()`, `handleDownload()`, `unsupported-preview.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (5 nodes): `Avatar()`, `formatRelativeDate()`, `getInitials()`, `SecuredBadge()`, `public-profile.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (4 nodes): `escapeRegex()`, `signupAndUnlock()`, `refresh-stability.spec.ts`, `uniqueEmail()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (4 nodes): `colourFor()`, `initials()`, `poll()`, `presence-avatars.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (4 nodes): `ContextMenu()`, `isPreviewable()`, `context-menu.tsx`, `preview.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (3 nodes): `ApiError`, `.constructor()`, `encrypted-upload-v2-contract.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 116`** (3 nodes): `deriveSasWords()`, `fnv1a()`, `sas-words.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 119`** (3 nodes): `ch()`, `migratePreferences()`, `notifications.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 124`** (2 nodes): `WasmChunkEncryptor`, `beebeeb_wasm.d.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `formatBytes()` connect `Community 4` to `Community 1`?**
  _High betweenness centrality (0.078) - this node is a cross-community bridge._
- **Why does `handleFolderFilesSelected()` connect `Community 1` to `Community 4`, `Community 7`?**
